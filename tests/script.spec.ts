...
// Boarding
await page.getByText("Anand Vihar ISBT").first().click();
console.log("✅ Boarding Selected");

// Dropping
await page.getByText("Mall Of Dehradun").first().click();
...
// console.log("Selecting Boarding & Dropping...");

// // Click Continue after Seat Selection
// await page.getByLabel(/Select boarding & dropping/i).click();
...
// await page.getByLabel(/Anand Vihar ISBT/i).first().click();
...
// await page.getByLabel(/Mall Of Dehradun/i).first().click();
...
// console.log("✅ Continued to Passenger Details");

// // Boarding Point
// // await page.getByLabel(/08:35 ISBT Kashmiri gate 47 - 49/i).click();
// // console.log("Boarding Point Selected");
// const boardingPoint = page.locator(
//     '[role="radio"]'
// ).first();
...
// // console.log("Dropping Point Selected");
// const droppingPoint = page.locator(
//     '[role="radio"]'
// ).nth(1);

// await expect(droppingPoint).toBeVisible();
